...
#### `/live2d status` (兼容旧写法: `/live2d.status`, `/l2d.status`)
...
#### `/live2d info` (兼容旧写法: `/live2d.info`, `/l2d.info`)
显示当前连接客户端的详细信息。
...
#### `/live2d list` (兼容旧写法: `/live2d.list`, `/l2d.list`, `/l2d.clients`)
列出所有当前连接的客户端。
...
#### `/live2d resources` (兼容旧写法: `/live2d.resources`, `/l2d.resources`, `/l2d.res`)
显示资源存储的详细统计信息。
...
#### `/live2d cleanup` (兼容旧写法: `/live2d.cleanup`, `/l2d.cleanup`)
手动触发资源和临时文件清理。
...
#### `/live2d config` (兼容旧写法: `/live2d.config`, `/l2d.config`, `/l2d.cfg`)
显示当前适配器的完整配置信息。
